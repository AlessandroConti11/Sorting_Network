...
private:
    ...
    static void sort_bitonic(vector<int>& array, int start_position, int array_size, bool direction);
    static void merge_bitonic(vector<int>& array, int start_position, int array_size, bool direction);
